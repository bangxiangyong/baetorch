import torch
from baetorch.baetorch.models_v2.base_autoencoder import SparseAutoencoderModule
...
lin_autoencoder = SparseAutoencoderModule(
...
conv_autoencoder = SparseAutoencoderModule(
    chain_params=chain_params,
    last_activation="sigmoid",
    last_norm=True,
    twin_output=False,
...
conv_linear_autoencoder = SparseAutoencoderModule(
    chain_params=chain_params,
    last_activation="sigmoid",
    last_norm=True,
    twin_output=False,
...
twin_autoencoder = SparseAutoencoderModule(
    chain_params=chain_params,
    last_activation="sigmoid",
    last_norm=True,
    twin_output=True,
...
conv1d_autoencoder = SparseAutoencoderModule(
    chain_params=chain_params,
    last_activation="sigmoid",
    last_norm=True,
    twin_output=False,
...
conv1d_lin_twin_autoencoder = SparseAutoencoderModule(
    chain_params=chain_params,
    last_activation="sigmoid",
    last_norm=True,
    twin_output=True,
