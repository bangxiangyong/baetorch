...
def convert_dataloader(x, y=None, batch_size=100, shuffle=False, drop_last=False):
    return DataLoader(
        SimpleDataset(x, y), batch_size=batch_size, shuffle=shuffle, drop_last=drop_last
    )
